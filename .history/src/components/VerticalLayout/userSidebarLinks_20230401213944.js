            ...
            <li>
                ...
                <li>
                    <Link to={ApproveLoanRoute} >
                        <i className="ti-check-box"></i> <span>Approve Loans</span>
                    </Link>
                </li>
                <li>
                    <Link to={DeclineLoanRoute} className="">
                        <i className="ti-thumb-down"></i> <span>Decline Loans</span>
                    </Link>
                </li>
                <li>
                    <Link to={DeclineLoanRoute} className="">
                        <i className="ti-thumb-down"></i> <span>Mondate form</span>
                    </Link>
                </li>
            </li>
        </>
