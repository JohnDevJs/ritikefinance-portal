...
function AccountForm() {
    ...
    const userData = userDet?.original?.userDetails;
    ...
    const handleValidSubmit = (e, values) => {
        ...
        formdata.append("OwnerType", userData?.OwnerType);
        formdata.append("Id_number", values.ID);
        ...
        formdata.append("Bank", values.accountName);
        ...
        fetch("https://prop.faspro24.com/api/owner/UpdateIndividualOwner", requestOptions)
