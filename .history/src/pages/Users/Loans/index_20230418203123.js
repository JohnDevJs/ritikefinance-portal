            ...
            <div className="page-content">
                ...
                <Container fluid>
                    <div className="page-title-box mx-4">
                        <button className="btn text-white apply__btn mb-4" onClick={() => setOpenModal(true)}> Apply for loan</button>
                        ...
                        {loading ? <Loading /> : <Table data={data} hideStatus={true} reFetch={reFetch} />}
                    </div>
                </Container>
            </div>

            <ModalComp
                ModalTitle="Apply for a loan"
                open={openModal}
