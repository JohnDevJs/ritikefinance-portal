                ...
                <Col md={6}>
                    <Card>
                        <div className="p-3">
                            ...
                            /> */}
                            <input type="text" value={inputValue} className="form-control" onChange={handleInputChange} />
                        </div>
                        <div className="p-3">
                            ...
                            /> */}
                            <input type="text" value={inputValue2} className="form-control" onChange={handleInputChange2} />
                        </div>
