...
//                                             <h4 className="mb-0 text-success">{approveLength < 10 ? `0${approveLength}` : approveLength} </h4>
//                                         </div>
...
//                     <Card className='card-border-radius'>
//                         <CardBody>
//                             <Link to={DeclineLoanRoute} className='Link_color'>
//                                 <Row className="align-items-center">
//                                     <div className='d-flex justify-content-between'>
//                                         <div>
//                                             <h5 className="custom-text-color text-danger">Decline Loans</h5>
//                                             <h4 className="mb-0 text-danger">{declineLength < 10 ? `0${declineLength}` : declineLength}</h4>
//                                         </div>
...
const LoanCardProcess = ({ length, approveLength, declineLength }) => {
    ...
    const loanData = [
        { route: LoansRoute, name: "Loan history", value: length, color: "primary", icon: <GiReceiveMoney size={40} /> },
        { route: ApproveLoanRoute, name: "Approved Loans", value: approveLength < 10 ? `0${approveLength}` : approveLength, color: "success", icon: <RiMoneyDollarCircleFill size={40} /> },
        { route: DeclineLoanRoute, name: "Declined Loans", value: declineLength < 10 ? `0${declineLength}` : declineLength, color: "danger", icon: <GiPayMoney size={40} /> },
    ];
