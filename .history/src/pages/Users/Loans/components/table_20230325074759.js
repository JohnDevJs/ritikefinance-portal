                                ...
                                data?.map((data, i) => {
                                    return (
                                        <Card className="mb-4" key={i}>
                                            <CardBody>
                                                <div>
                                                    {/* <h5>Full name{data?.user?.firstName} {data?.user?.lastName}</h5> */}
                                                    <p>Amount: {data?.amount}</p>
                                                    <p>Duration: {data?.duration}</p>
                                                    <p>Loan date: {data?.createdAt.split("T")[0]}</p>
                                                    <p>Paid date: {"2022-05-20"}</p>

                                                    {data?.status === "pending" ? <p> Status: <b className="bg-warning p-2"> Pending </b> </p> : null}
                                                    {data?.status === "decline" ? <p> Status:  <b className="bg-danger  p-2"> Declined </b>  </p> : null}
                                                    {data?.status === "verification" ? <p> Status: <b className="bg-info  p-2"> Verification </b> </p> : null}
                                                    {data?.status === "approve" ? <p> Status: <b className="bg-primary  p-2"> Approved </b> </p> : null}
                                                ...
                                                <div className='d-flex justify-content-between mt-2'>
                                                    <button className='btn text-white' onClick={() => viewDetails(data?._id)}>
                                                        <IoIosEye size={22} />Click to view
                                                    </button>
