...
function LoanForm({ onClose, reFetch }) {
    ...
    const onChangeDate = ({ target }) => {
        ...
        */
        ...
        if (diffInDays < 1) {
            alert("Please choose a correct payment date.");
        }
                ...
                <Col md={12}>
                    <div className='mt-5'>
                        ...
                        <div className="">
                            ...
                            <input disabled min="1" max="31" type="number" value={numberOfDays} className="form-control" onChange={handleInputChange2}
                            />
                        </div>
                    </div>
