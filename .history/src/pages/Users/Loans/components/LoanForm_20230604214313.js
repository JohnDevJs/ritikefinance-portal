...
function LoanForm({ onClose, reFetch }) {
    ...
    const applyLoan = () => {
        ...
        formdata.append("bankStatement_and_payslip", payslip);
        formdata.append("bankStatement_and_payslip", bankStatement);
            ...
            <Row className='loan__form'>
                ...
                <Col md={6}>
                    ...
                    <div className='mt-5'>
                        ...
                        <input type="file" className="form-control" name="bankStatement" />
                    </div>
                </Col>

                <div className="px-3">
                    <CustomBtn Pending={pending} btnName="Apply now" onClick={applyLoan} onChange={handleBankStatementFileChange} />
                </div>
