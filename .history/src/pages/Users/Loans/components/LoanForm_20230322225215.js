        ...
        <>
            <Row className='loan__form'>
                ...
                <Col md={6}>
                    ...
                    <div className="p-3">
                        <h4 className="font-size-14 mb-3 mt-0 css_font_style">Loan amount</h4>
                        <span className="float-start css_font_style">R100</span>
                        <span className="float-end css_font_style">R2000</span>
                        {/* <Slider
                                value={amount}
                                min={100}
                                max={1000}
