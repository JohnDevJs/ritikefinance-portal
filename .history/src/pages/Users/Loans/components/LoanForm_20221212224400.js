...
function LoanForm({ onClose, reFetch }) {
    ...
    // const refFileUploadBankStatement2 = React.useRef(null);
    ...
    // const [bankStatementServer2, setBankStatementServer2] = React.useState();
    ...
    // const onThumbChangeClickBankStatement2 = () => {
    //     if (refFileUploadBankStatement2) {
    //         refFileUploadBankStatement2.current.dispatchEvent(new MouseEvent('click'));
    //     }
    // };
    ...
    // const changeThumbBankStatement2 = (event) => {
    //     if (event.target.files && event.target.files[0]) {
    //         setBankStatementServer2(event.target.files[0]);

    //         const reader = new FileReader();
    //         reader.onload = (loadEvent) => {
    //             setBankStatement2(loadEvent.target.result);
    //         };
    //         reader.readAsDataURL(event.target.files[0]);
    //     }
    // };
    ...
    const applyLoan = () => {
        ...
        // formdata.append("bankStatement", bankStatementServer2);
        formdata.append("loanPercentage", percentage);
        ...
        <>
            <Row>
                ...
                {/* <Col md={4}>
                    <label>Upload your bank statement</label>
                    <div className="d-flex justify-content-center align-items-center border">
                        <img src={bankStatement2 === undefined ? Image : bankStatement2} alt="" width={350} height={200} />
                        <Button className="btn-icon btn-icon-only position-absolute"
                            onClick={onThumbChangeClickBankStatement2}
                        > <FcAddImage size={40} />
                        </Button>
                        <input type="file" ref={refFileUploadBankStatement2} className="file-upload d-none" accept="image/*" onChange={changeThumbBankStatement2} />
                    </div>
                </Col> */}
