        ...
        <>
            <Row className='loan__form'>
                ...
                <div className='mt-5'>
                    ...
                    <p className='mx-2'> 2  I  consent to XDS releasing a copy of my credit to ritikefinance having sight of the content of my credit report for the above purpose.  </p>
                </div>
