                            ...
                            {pending ? (
                                ...
                                <>
                                    {data?.data?.data?.length > 0 ? (
                                        ...
                                        <div className="container__zero__lenght" style={{ textAlign: 'center', marginTop: '50px' }}>
                                            <p style={{ fontSize: '24px', fontWeight: 'bold', color: '#777' }}>Oops, looks like there's no data to display!</p>
                                            <p style={{ fontSize: '16px', color: '#999', marginTop: '20px' }}>Don't worry, though. You can try again later or check back with us soon.</p>
                                        </div>
                                    )}
                                </>
                            )}
