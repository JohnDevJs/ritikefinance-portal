                            ...
                            <Row className="align-items-center Link_color">
                                <div className='d-flex justify-content-between custom-color'>
                                    <div>
                                        ...
                                        <h5 className="mb-0 color">R {loanAmount ? loanAmount : 0} </h5>
                                    </div>
                            ...
                            <Row className="align-items-center Link_color">
                                <div className='d-flex justify-content-between custom-color'>
                                    <div>
                                        ...
                                        <h5 className="mb-0 color">R {totalInterest ? totalInterest : 0} </h5>
                                    </div>
                                    <div className='btn-custom-color'>
                                        <GiReceiveMoney size={50} />
                                    </div>
                            ...
                            <Row className="align-items-center Link_color">
                                <div className='d-flex justify-content-between custom-color'>
                                    <div>
                                        ...
                                        <h5 className="mb-0">R {amountPlusInterest ? amountPlusInterest : 0} </h5>
                                    </div>
                                    <div className='btn-custom-color'>
                                        <GiReceiveMoney size={50} />
                                    </div>
