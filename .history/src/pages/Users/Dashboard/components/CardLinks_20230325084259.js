    ...
    const cardData = [
        {
            title: 'Total loans',
            count: length,
            icon: <GiTakeMyMoney className="card-icon" />,
            link: LoansRoute
        },
        {
            title: 'Pending loans',
            count: data.filter(res => res.status === "pending").length,
            icon: <GiPayMoney className="card-icon" />,
            link: '#'
        },
        {
            title: 'Decline Loans',
            count: data.filter(res => res.status === "decline").length,
            icon: <TbReportMoney className="card-icon" />,
            link: '#'
        },
        {
            title: 'Paid loans',
            count: data.filter(res => res.status === "paid").length,
            icon: <RiMoneyDollarCircleFill className="card-icon" />,
            link: '#'
        }
    ];
