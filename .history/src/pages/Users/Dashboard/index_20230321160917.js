                ...
                <Container fluid>
                    <div className="page-title-box">
                        ...
                        <div className="user__name">
                            <h3 className="mb-5 text-success">Hi, {userDet?.data?.data?.firstName} {userDet?.data?.data?.lastName} </h3>
                            <Link to="/loans" className="btn text-white apply__btn mb-4"> Apply for a loan</Link>
                        </div>
