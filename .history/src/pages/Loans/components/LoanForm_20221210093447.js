            ...
            <Row>
                ...
                <Col md={6}>
                    ...
                    <div className="d-flex justify-content-center align-items-center border">
                        ...
                        <input type="file" ref={refFileUploadPaySleep} className="file-upload d-none" accept="image/*" onChange={changeThumb} />
                    </div>
                </Col>
                ...
                <Col md={6}>
                    ...
                    <div className="d-flex justify-content-center align-items-center border">
                        ...
                        <input type="file" ref={refFileUploadBankStatement} className="file-upload d-none" accept="image/*" onChange={changeThumb} />
                    </div>
                </Col>
