...
function LoanForm() {
    ...
    const applyLoan = () => {
        ...
        formdata.append("paySlip", values.gender);
        formdata.append("bankStatement", values.email);
        formdata.append("loanPercentage", values.address);
        formdata.append("user", values.areaCode);
                    ...
                    <Card>
                        <CardBody>
                            ...
                            <form className="px-3">
                                ...
                                <input type="date" className="form-control" onChange={date => setPaymentDate(date)} />
                            </form>
                            <div className="d-flex justify-content-between p-3">
