    ...
    return (
        <>
            <Row>
                ...
                <Col md={6}>
                    <label>Upload your latest pay sleep</label>
                    <div className="d-flex justify-content-center align-items-center border">
                        <img src={paySleep === undefined ? Image : paySleep} alt="user" width={300} height={200} />
                ...
                <Col md={6}>
                    ...
                    <div className="d-flex justify-content-center align-items-center border">
                        <img src={bankStatement === undefined ? Image : bankStatement} alt="user" width={300} height={200} />
                        <Button className="btn-icon btn-icon-only position-absolute"
                ...
                <Col md={6}>
                    <Card>
                        <CardBody>
                            ...
                            <button onClick={applyLoan} className='btn text-white w-100 px-3'>Apply now</button>
                        </CardBody>
                    </Card>
                </Col>
