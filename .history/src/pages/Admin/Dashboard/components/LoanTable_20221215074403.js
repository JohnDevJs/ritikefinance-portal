...
const column = [
    ...
    { label: "Amount", field: "loanPercentage", sort: "asc", width: 150 },
    { label: "Amount", field: "payment_Date", sort: "asc", width: 150 },
    { label: "Amount", field: "status", sort: "asc", width: 150 },
    { label: "Amount", field: "totalAmount", sort: "asc", width: 150 },
