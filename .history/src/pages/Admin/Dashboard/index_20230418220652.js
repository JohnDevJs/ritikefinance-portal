...
const Index = () => {
    ...
    const { data, loading, error, reFetch, pending } = useFetch(`${process.env.REACT_APP_BACKEND_URL}/loans`, null);
    ...
    return (
        <React.Fragment>
            ...
            <SmallModal
                ...
                cancel="close"
                Components={<ModalComp pending={pending} reFetch={reFetch} onClose={() => setDeleteRequest(false)} request_Id={requestId} btnName={btnName} apiQuery={apiQuery} />}
            />
