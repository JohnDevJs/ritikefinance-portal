...
const Index = () => {
    ...
    const res_data = [];
    const { data, loading, error, reFetch } = useFetch(`${process.env.REACT_APP_BACKEND_URL}/loans?status=decline &status=paid&loanPercentage[lt]=100`, token);
    ...
    return (
        <React.Fragment>
            <div className="page-content px-5">
                <Breadcrumb default={LoanRequestRoute} defaultName="Declined Loan" title={"Loans"} />
