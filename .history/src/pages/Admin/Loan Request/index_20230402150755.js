...
import { ApprovedLoanMsg, DeclinedLoanMsg, LoginMsg, ServerError, VerificationLoanMsg } from "components/NotifyMessage";
...
const Index = () => {
    ...
    console.log(" userDet : ", userDet?.data?.data?._id)
