    ...
    const filterArr = () => {
        data.forEach(res => {
            res_data.push({
                ...
                viewBtn: <button className="btn  color__blue"> View </button>,
                verifyBtn: <button className="btn  color__verify" onClick={() => verifyFunc(res._id)}> Verification </button>,
                approveBtn: <button className="btn  color__green" onClick={() => approveFunc(res._id)}> Approve </button>,
                declineBtn: <button className="btn  color__red" onClick={() => declineFunc(res._id)}> Decline </button>,
                downloadBtn: <button className="btn  color__download"> Download </button>,
            })
        });
    }
    filterArr();
