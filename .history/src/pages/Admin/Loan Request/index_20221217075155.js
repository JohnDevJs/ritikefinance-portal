    ...
    const filterArr = () => {
        data.forEach(res => {
            res_data.push({
                ...
                approveBtn: <button className="btn btn-danger color__green" onClick={() => verifyFunc(res._id)}> Approve </button>,
                declineBtn: <button className="btn btn-danger color__red" onClick={() => verifyFunc(res._id)}> Decline </button>,
