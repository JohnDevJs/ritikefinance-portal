    ...
    const filterArr = () => {
        data.forEach(res => {
            res_data.push({
                ...
                verifyBtn: <button className="btn btn-danger color__verify" onClick={() => setOpenModal(true)}> Verification </button>,
    ...
    return (
        <React.Fragment>
            ...
            <SmallModal
                ...
                cancel="cancel"
                Components={<VerifyModal reFetch={reFetch} onClose={() => setOpenModal(false)} />}
            />
