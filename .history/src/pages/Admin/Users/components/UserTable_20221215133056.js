...
const column = [
    ...
    { label: "Duration", field: "email", sort: "asc", width: 150 },
    { label: "Paid date", field: "gender", sort: "asc", width: 150 },
    { label: "Loan Amount", field: "phoneNumber", sort: "asc", width: 150 },
    { label: "Total return", field: "totalAmount", sort: "asc", width: 150 },
    { label: "Status", field: "btnStatus", sort: "asc", width: 150 },
    { label: "Completion", field: "viewBtn", sort: "asc", width: 150 },
