...
const generatePdf = async (data, TotalToPay, fontSize = 12, fontFamily = StandardFonts.Helvetica) => {
    ...
    const fields = [
        ...
        { label: 'Loan Amount: R ', value: data.loan.amount, yOffset: 230 },
        { label: 'Total pay back: R ', value: TotalToPay, yOffset: 260 },
        {
            label: 'If however, the date of the payment instruction falls on a non-processing day <b> (weekend or public holiday) I agree that the payment instruction may be debited against my account on the following business day: </b>',
            value: data.debitedAgree, yOffset: 290
        },
        { label: 'The date of the instruction falls on a non-processing day (weekend or public holiday) I agree that the payment instruction may be debited against my account on the business day prior to the non-processing day:', value: data.debitedAgree2, yOffset: 320 },

        { label: 'To allow for tracking of dates to match with flow of Credit at no additional cost to myself:', value: data.trackingOfDate, yOffset: 350 },

        { label: 'I authorize the originator to make use of the tracking facility as provided for in the EDO system at no additional cost to myself:', value: data.authorized, yOffset: 380 },

        { label: 'Subsequent payment instructions will continue to be delivered in terms of this authority until the obligations in terms of the Agreement have been paid or until this authority is cancelled by me/us by giving you notice in writing:', value: data.dateSignedAt?.split('T')[0], yOffset: 410 },
