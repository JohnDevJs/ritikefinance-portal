...
const generatePdf = async (data, fontSize = 15, fontFamily = StandardFonts.Helvetica) => {
    ...
    const fields = [
        ...
        { label: 'Bank Name:', value: data.user.bankName, yOffset: 160 },
        { label: 'Payment Date:', value: data.loan.paymentDate.split('T')[0], yOffset: 180 },
        { label: 'Loan Amount:', value: data.loan.amount, yOffset: 200 },
    ];
