...
function LoanDetails({ loanId }) {
    ...
    const { data, loading, error, reFetch } = useFetch(
        `${process.env.REACT_APP_BACKEND_URL}/mandates/${loanId}`,
        token
    );
    const totalToPay = parseInt(data?.loan?.totalAmount) + parseInt(data?.loan?.amount);
            ...
            <CardBody>
                ...
                <Row>
                    <Col>
                        ...
                        <p>
                            <b>Phone number:</b> {data?.user?.phoneNumber}
                        </p>
                        <p>
                            <b>Email:</b> {data?.user?.email}
                        </p>
                        <p>
                            <b>Account Number:</b> {data?.user?.accountNumber}
                        </p>
                        <p>
                            <b>Bank Name:</b> {data?.user?.bankName}
                        </p>
                        <p>
                            <b>Payment Date:</b> {data?.loan?.paymentDate.split('T')[0]}
                        </p>
                        <p>
