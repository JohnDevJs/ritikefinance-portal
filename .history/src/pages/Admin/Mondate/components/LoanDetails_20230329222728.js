    ...
    return (
        <Row>
            ...
            <div className='mt-4'>
                ...
                <h3 className='text-primary'>{data?.debitedAgree2 ? "Yes" : "No"}</h3>
            </div>
            <div className='mt-4'>
                <h5>
                    To allow for tracking of dates to match with flow of Credit at no additional cost to myself.
                </h5>
                <h3 className='text-primary'>{data?.trackingOfDate ? "Yes" : "No"}</h3>
            </div>
            <div className='mt-4'>
                <h5>
                ...
                <h3 className='text-primary'>{data?.authorized ? "Yes" : "No"}</h3>
            </div>
            <div className='mt-4'>
                <h5>
                ...
                <h3 className='text-primary'>{data?.dateSignedAt?.split('T')[0]}</h3>
            </div>
            <div className='mt-4'>
                <h4> ASSIGNMENT</h4>
                <h5>
                ...
                <h3 className='text-primary'>{data?.agreement ? "Yes" : "No"}</h3>
            </div>
