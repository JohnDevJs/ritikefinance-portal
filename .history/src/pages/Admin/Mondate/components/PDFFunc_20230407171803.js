...
const generatePdf = async (data, fontSize = 15, fontFamily = StandardFonts.Helvetica) => {
    ...
    const fields = [
        ...
        { label: 'Account Number:', value: data.user.accountNumber, yOffset: 130 },
        { label: 'Bank Name:', value: data.user.bankName, yOffset: 150 },
        { label: 'Payment Date:', value: data.loan.paymentDate.split('T')[0], yOffset: 170 },
